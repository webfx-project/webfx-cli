...
public class IndexHtmlFile extends DevModuleFileImpl {
    ...
    public boolean writeFile() {
        ...
        Boolean pwa = module.isPwa();
        if (Booleans.isTrue(pwa)) {
            headSb.append("""
        ...
        ReusableStream.concat(
                ...
                Booleans.isTrue(pwa) ? null : ReusableStream.of(XmlUtil.lookupElement(XmlUtil.parseXmlString("<html><body order='0'><script type='text/javascript' charset='utf-8' src='./" + getApplicationJsScriptFileName(module) + "'/></body></html>").getRootElement(), "/html[1]")),
