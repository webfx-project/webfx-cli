...
public final class RootConfigFileGenerator {
    ...
    public static void generateExecutableModuleConfigurationResourceFile(DevProjectModule module, boolean canUseCache) {
        if (module.isExecutable()) {
            ...
            confMerge.mergeConfigs(propertiesPath, jsonPath);
        }
    }
}