...
public class BuildInfo {
    ...
    public BuildInfo(ProjectModuleImpl projectModule) {
        ...
        isForJ2cl = projectModule.getTarget().hasTag(TargetTag.J2CL);
        isForGwt = !isForJ2cl && projectModule.getTarget().isMonoPlatform(Platform.GWT);
        ...
        isJ2clCompilable = isForJ2cl || projectModule.getTarget().isPlatformSupported(Platform.GWT) && !SpecificModules.isModuleIntegratedToWebfxKitJ2cl(projectModule.getName());
